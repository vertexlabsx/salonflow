...
export interface OwnerClient {
  ...
  membershipId: string; membershipPlanName?: string; packageName?: string; packageCreditsRemaining?: number; subscriptionName?: string; subscriptionStatus?: string; outstandingPaise: number; createdAt: string; updatedAt: string;
}

...
async function main() {
  ...
  for (let i = 0; i < 30; i += 1) {
    ...
    users.push({
      ...
      staffAppPermissions: ["read:appointments", "create:appointments", "update:appointments", "read:staff", "read:clients", "create:clients", "update:clients", "allow:staff-checkin-checkout", "read:reports"],
      crmPermissions: ["read:appointments", "create:appointments", "update:appointments", "read:staff", "read:clients", "create:clients", "update:clients"],
      status: "active",

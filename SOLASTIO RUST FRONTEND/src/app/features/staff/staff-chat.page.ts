...
@Component({
  ...
  styles: [`
    ...
    .chat-local-search > label { display: block; margin-bottom: 7px; color: var(--staff-text-secondary); font-size: .72rem; font-weight: 800; letter-spacing: .045em; }
    .chat-search-control { min-height: 44px; display: grid; grid-template-columns: 18px minmax(0, 1fr) auto; align-items: center; gap: 8px; padding: 0 11px; border: 1px solid var(--staff-border); border-radius: 14px; background: var(--staff-input-background); color: var(--staff-text-secondary); transition: border-color .4s ease-out, background-color .4s ease-out, box-shadow .4s ease-out; }
    .chat-search-control:focus-within { border-color: var(--staff-input-focus); background: #fffdfa; box-shadow: 0 0 0 3px var(--staff-input-focus-ring); }
    .chat-search-control input { width: 100%; min-width: 0; height: 42px; padding: 0; border: 0; outline: 0; background: transparent; color: var(--staff-input-text); font: inherit; }
    .chat-search-control input::placeholder { color: var(--staff-input-placeholder); }
    .chat-search-control small { color: var(--staff-text-secondary); font-size: .68rem; white-space: nowrap; }
    .message-search { padding: 12px clamp(12px, 3vw, 22px) 8px; border-top: 1px solid var(--staff-border); }
    .conversation-copy { min-width: 0; }
    .conversation-active { display: block; margin-top: 5px; color: var(--staff-text-secondary); font-size: .7rem; font-weight: 650; letter-spacing: .015em; }
    .chat-conversation.active .conversation-active { color: var(--staff-primary-hover); }
    .chat-message-list { gap: 11px; }
    .message-date-separator { display: flex; align-items: center; gap: 10px; margin: 17px 0 7px; color: var(--staff-text-secondary); font-size: .68rem; font-weight: 750; letter-spacing: .08em; text-transform: uppercase; }
    .message-date-separator::before, .message-date-separator::after { content: ''; height: 1px; flex: 1; background: var(--staff-border); }
    .chat-message { position: relative; margin-top: 3px; }
    .chat-message.grouped { margin-top: 6px; }
    .message-avatar { position: absolute; left: -34px; top: 1px; width: 26px; height: 26px; display: grid; place-items: center; border: 1px solid var(--staff-border); border-radius: 9px; background: var(--staff-surface-secondary); color: var(--staff-primary-hover); font-size: .62rem; font-weight: 800; letter-spacing: .04em; }
    .chat-message.mine .message-avatar { right: -34px; left: auto; background: var(--staff-primary); color: var(--staff-on-primary); }
    ...
    .message-sent { display: block; margin-top: 5px; color: var(--staff-text-secondary); font-size: .67rem; font-weight: 650; text-align: right; }
    .chat-message.mine .message-sent { color: color-mix(in srgb, var(--staff-primary-hover) 78%, var(--staff-text-secondary)); }
    .chat-typing { min-height: 18px; margin: 0 clamp(14px, 3vw, 24px) 7px; color: var(--staff-primary); font-size: .75rem; font-weight: 650; }

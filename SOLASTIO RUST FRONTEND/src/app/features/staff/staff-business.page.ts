...
@Component({
  ...
  styles: [`
    ...
    @media (max-width:700px) {
      .business-page { padding-inline:14px; padding-bottom:var(--staff-bottom-clearance); }
      .business-page .page-head { padding:16px; border-bottom:1px solid color-mix(in srgb,var(--staff-primary) 18%,var(--staff-border)); }
      .business-filter-panel .form-grid,.business-filter-panel .permission-actions,.advanced-filters > .form-grid,.filter-primary { grid-template-columns:1fr; }
      .business-filter-panel .permission-actions .button { width:100%; }
      .metric-overview,.analytics-preview-grid,.ai-insight-list,.status-mix-grid.grid.four,.invoice-totals-grid.grid.four,.earnings-grid.grid.four,.earnings-summary-grid,.period-summary-list,.appointment-detail-grid,.business-loading > div { grid-template-columns:1fr; }
      .grid.four.business-kpi-grid { grid-template-columns:repeat(2,minmax(0,1fr)); }
      .status-mix-grid .kpi,.business-kpi-grid .kpi,.invoice-totals-grid .kpi,.earnings-grid .kpi,.financial-metric { min-height:74px; padding:11px 12px; }
      .analytics-card[open],.analytics-card { grid-column:1 / -1; }
      .analytics-card > summary { min-height:118px; }
      .ai-insight-list p,.period-summary-list p { padding:10px 0; border-left:0; border-top:1px solid rgba(255,255,255,.08); }
      .ai-insight-list p:first-child,.period-summary-list p:first-child { border-top:0; }
      .earnings-compact-summary,.revenue-hero-summary,.status-summary { grid-template-columns:1fr !important; min-height:0 !important; padding:12px !important; }
      .earnings-compact-summary > span,.revenue-hero-summary > span,.status-summary > span { min-height:44px; padding:7px 0 !important; border-left:0 !important; border-top:1px solid var(--business-line); }
      .earnings-compact-summary > span:first-child,.revenue-hero-summary > span:first-child,.status-summary > span:first-child { border-top:0; }
      .earnings-compact-summary > i,.revenue-hero-summary > i,.status-summary > i { position:absolute; top:12px; right:12px; }
      .activity-primary { display:grid; gap:8px; }
      .activity-status.badge { justify-self:start; max-width:100%; }
      .activity-facts { grid-template-columns:1fr 1fr; }
      .activity-entry > summary { min-height:0; padding:14px 0; }
      .activity-entry .appointment-expanded .row-actions { grid-template-columns:1fr; }
      .detail-drawer { inset:0; width:100vw; border-left:0; }
    }
    @media (max-width:380px) {
      .business-page { padding-inline:12px; }
      .grid.four.business-kpi-grid,.activity-facts { grid-template-columns:1fr; }
      .status-mix-grid .kpi,.business-kpi-grid .kpi,.invoice-totals-grid .kpi,.earnings-grid .kpi,.financial-metric { min-height:70px; }
      .analytics-detail .chart-row { grid-template-columns:1fr; }
      .analytics-detail .chart-row strong { text-align:left; }
    }
